...
"""
Нужно составить таблицу кодов всех символов. Рекурсивно пройдем по веткам дерева, пока не достигнем листьев, там будут
строковые значение. Пока движемся к листку, добавляем нули и единицы к коду.
"""
